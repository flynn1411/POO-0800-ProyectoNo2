...
public class LyricsProxy implements soap.Lyrics {
  private String _endpoint = null;
  private soap.Lyrics lyrics = null;
  ...
  private void _initLyricsProxy() {
    try {
      lyrics = (new soap.LyricsServiceLocator()).getLyrics();
      if (lyrics != null) {
        if (_endpoint != null)
