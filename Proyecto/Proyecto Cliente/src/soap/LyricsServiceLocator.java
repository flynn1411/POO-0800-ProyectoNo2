...
public class LyricsServiceLocator extends org.apache.axis.client.Service implements soap.LyricsService {
    ...
    private java.lang.String Lyrics_address = "http://localhost:8080/LyricsService/services/Lyrics";
    ...
    public soap.Lyrics getLyrics() throws javax.xml.rpc.ServiceException {
    ...
    public soap.Lyrics getLyrics(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            soap.LyricsSoapBindingStub _stub = new soap.LyricsSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (soap.Lyrics.class.isAssignableFrom(serviceEndpointInterface)) {
                soap.LyricsSoapBindingStub _stub = new soap.LyricsSoapBindingStub(new java.net.URL(Lyrics_address), this);
                _stub.setPortName(getLyricsWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://soap", "LyricsService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://soap", "Lyrics"));
        }
