function ViewFunctions(){
    ...
    var pathOfLibrary = "http://localhost:8080/Proyecto2_v0.5/public/Library/";
    var valueScroll = 0;
    //------------------ Muestra los artistas y albumes en la pagina. -----------------
    this.loadArtistsAndAlbums = function(){
        objSong.controls.volumen = false;
    ...
    this.playOrPauseSong = function(){
        this.changeCurrentStateSong();
        //console.log(`${objSong.currentTime}/${objSong.duration}`);
    }
    ...
    this.songChangeScroll = function(){
        if(valueScroll <=100 && objSong.paused == false){
            changeScrollbar.style.width = `${valueScroll}%`;
            //console.log("deplazando...");
    ...
    this.newPointScroll = function(){
        //console.log(totalScrollbar.event.clientX);
    }
}    